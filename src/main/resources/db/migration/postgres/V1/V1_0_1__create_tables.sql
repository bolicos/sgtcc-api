...
(
    ...
    ADVISORS_BOARD BOOLEAN NOT NULL,
...
(
    FK_ROLE_UID BIGINT NOT NULL,
    FK_USER_UID BIGINT NOT NULL,
    TYPE BIGINT
);
CREATE TABLE TITLES
(
...
CREATE TABLE EXAMINATIONS_TYPES
(
    ID BIGINT CONSTRAINT PK_EXAMINATIONS_TYPES PRIMARY KEY,
