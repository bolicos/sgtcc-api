...
public class InterestAreaController {
    ...
    public ResponseEntity<InterestArea> findById(@PathVariable Long id) {
    ...
    public ResponseEntity<ResourceCreated> save(@RequestBody InterestAreaRequest interestAreaRequest) {
        return new ResponseEntity<>(interestAreaService.save(interestAreaRequest), HttpStatus.CREATED);
    }
}
